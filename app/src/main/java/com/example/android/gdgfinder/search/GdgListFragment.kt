        ...
        viewModel.regionList.observe(viewLifecycleOwner, object:Observer<List<String>>{
            override fun onChanged(data: List<String>?) {
                ...
                val children = data.map{ regionName ->
                    ...
                    chip.tag = regionName
                    chip.chipIcon = resources.getDrawable(when(chip.tag){
                        "Asia"->R.drawable.common_full_open_on_phone
                        else->R.drawable.ic_launcher_foreground
                    })
                    //chip.chipBackgroundColor = ColorStateList.valueOf(ContextCompat.getColor(context!!, R.color.secondaryColor))
